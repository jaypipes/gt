...
func main() {
	...
	// We make the bounding box of the canvas (the outermost renderable of the
	// Application) a rectangle, anchored at cell (10,10) that is 40 cells wide
	// and 20 cells high.
	canvasBounds := gt.Rect(10, 10, 40, 20)

	// By specifying a bounding box (bounds) on the Application's canvas, we
	...
	// the canvas's bounding box causes the actual rendered box to be "clipped"
